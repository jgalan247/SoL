...
class FISTest {
    ...
    generatePDF(score, total, percentage, passed, results) {
        ...
        doc.text('LIBF FCMME Test Results', 105, 15, { align: 'center' });
        ...
        doc.text('LIBF Level 2 Certificate in Financial Education - FCMME Unit 2', 105, 290, { align: 'center' });
